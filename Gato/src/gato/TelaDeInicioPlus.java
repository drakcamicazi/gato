 ...
 * @author Admin
 */
public class TelaDeInicioPlus extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeInicio
     */
    public TelaDeInicioPlus() {
        initComponents();
    }
...
private void preencherListaEventos(String[] eventos)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeInicioPlus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeInicioPlus().setVisible(true);
            }
        });
    }
