 ...
 * @author USER
 */
public class TesteCalendarioRotina extends javax.swing.JFrame {
     ...
     */
    public TesteCalendarioRotina() { // Preciso de quantos eventos vao ser adicionados em cada dia, um vetor com os nomes destes(em ordem de horario das 00:00 ate 24:00), um vetor de qual hora esse evento ocorre e qual dia( ex: Segunda )
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TesteCalendarioRotina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TesteCalendarioRotina().setVisible(true);
            }
        });
    }
